var Client = IgeClass.extend({
	...
	loadTextures: function () {
		this.gameTexture.background1 = new IgeTexture('../OSMGame/assets/textures/backgrounds/grassTile.png');
		this.gameTexture.bank = new IgeTexture('../OSMGame/assets/textures/buildings/bank1.png');
		this.gameTexture.electricals = new IgeTexture('../OSMGame/assets/textures/buildings/electricalsShop1.png');
		this.gameTexture.burgers = new IgeTexture('../OSMGame/assets/textures/buildings/burgerShop1.png');
		this.gameTexture.base_se = new IgeTexture('../OSMGame/assets/textures/buildings/base_se.png');
		this.gameTexture.base_se_left = new IgeTexture('../OSMGame/assets/textures/buildings/base_se_left.png');
		this.gameTexture.base_se_middle = new IgeTexture('../OSMGame/assets/textures/buildings/base_se_middle.png');
		this.gameTexture.base_se_right = new IgeTexture('../OSMGame/assets/textures/buildings/base_se_right.png');
		this.gameTexture.base_sw = new IgeTexture('../OSMGame/assets/textures/buildings/base_sw.png');
		this.gameTexture.base_sw_left = new IgeTexture('../OSMGame/assets/textures/buildings/base_sw_left.png');
		this.gameTexture.base_sw_middle = new IgeTexture('../OSMGame/assets/textures/buildings/base_sw_middle.png');
		this.gameTexture.base_sw_right = new IgeTexture('../OSMGame/assets/textures/buildings/base_sw_right.png');
		this.gameTexture.stacker_se = new IgeTexture('../OSMGame/assets/textures/buildings/stacker_se.png');
		this.gameTexture.stacker_se_left = new IgeTexture('../OSMGame/assets/textures/buildings/stacker_se_left.png');
		this.gameTexture.stacker_se_middle = new IgeTexture('../OSMGame/assets/textures/buildings/stacker_se_middle.png');
		this.gameTexture.stacker_se_right = new IgeTexture('../OSMGame/assets/textures/buildings/stacker_se_right.png');
		this.gameTexture.stacker_sw = new IgeTexture('../OSMGame/assets/textures/buildings/stacker_sw.png');
		this.gameTexture.stacker_sw_left = new IgeTexture('../OSMGame/assets/textures/buildings/stacker_sw_left.png');
		this.gameTexture.stacker_sw_middle = new IgeTexture('../OSMGame/assets/textures/buildings/stacker_sw_middle.png');
		this.gameTexture.stacker_sw_right = new IgeTexture('../OSMGame/assets/textures/buildings/stacker_sw_right.png');
		this.gameTexture.crane_se = new IgeTexture('../OSMGame/assets/textures/buildings/crane_se.png');
		this.gameTexture.crane_sw = new IgeTexture('../OSMGame/assets/textures/buildings/crane_sw.png');
		this.gameTexture.crane_ne = new IgeTexture('../OSMGame/assets/textures/buildings/crane_ne.png');
		this.gameTexture.crane_nw = new IgeTexture('../OSMGame/assets/textures/buildings/crane_nw.png');

		this.gameTexture.uiButtonSelect = new IgeTexture('../OSMGame/assets/textures/ui/uiButton_select.png');
		this.gameTexture.uiButtonMove = new IgeTexture('../OSMGame/assets/textures/ui/uiButton_move.png');
		this.gameTexture.uiButtonDelete = new IgeTexture('../OSMGame/assets/textures/ui/uiButton_delete.png');
		this.gameTexture.uiButtonHouse = new IgeTexture('../OSMGame/assets/textures/ui/uiButton_house.png');
